...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts() async {
    const url = 'https://shop-15674-default-rtdb.firebaseio.com/products.json';
    try {
  ...
  Future<void> addProduct(Product product) async {
    final url = 'https://shop-15674-default-rtdb.firebaseio.com/products.json';
    try {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url =
          'https://shop-15674-default-rtdb.firebaseio.com/products/$id.json';
  ...
  void deleteProduct(String id) {
    final url = Uri.parse(
        'https://shop-15674-default-rtdb.firebaseio.com/products/$id');
